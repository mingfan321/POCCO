...
parser = argparse.ArgumentParser(description='verify_mokp_hyperparameter')
...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': './result/20240915_154626_train__kp_mix',  # directory path of pre-trained model and log files saved.
